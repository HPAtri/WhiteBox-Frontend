    ...
    <div class="main">
      <el-dialog :title="dialogTitle" :visible.sync="updateVisible" width="50%"  @close="closeForm()">
        <el-form :model="updateform" :rules="rules" ref="updateform" :inline=true style="margin-left:20px;" label-width="110px" label-position="right" size="mini">
            <el-form-item label="nickname" prop="yonghu">
            ...
            <el-form-item label="birthday" prop="birthday">
                <el-input v-model="updateform.birthday" suffix-icon="el-icon-edit"></el-input>
            </el-form-item>
            <el-form-item label="sex" prop="sex">
                <el-input v-model="updateform.sex" suffix-icon="el-icon-edit"></el-input>
            </el-form-item>
            <el-form-item label="profile" prop="profile">
                <el-input v-model="updateform.profile" suffix-icon="el-icon-edit"></el-input>
            </el-form-item>
        </el-form>
