...
<script>
  ...
  export default {
    ...
    update(){
      this.updateform.nickname = this.updateform.nickname 
      this.updateform.icon = this.updateform.nickname 
      this.updateform.nickname = this.updateform.nickname 
      this.updateform.phone_number = this.updateform.nickname 
      this.updateform.birthday = this.updateform.nickname 
      this.updateform.sex = this.updateform.nickname 
      this.updateform.profile = this.updateform.nickname 
