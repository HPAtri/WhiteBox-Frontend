        ...
        <div class="extra">
          <div class="extrabox">
            <div class="scorebox">
                ...
                <div class="buttonbox">
                    <el-button type="primary" style="margin-right: 10px;" @click="collect(gameid)">加入收藏</el-button>
                    <el-button type="warning">提交评分</el-button>
                </div>
...
export default {
    ...
    beforeMount(){
        ...
        .then(res=>{
            ...
            this.gameid = this.gameList[0].name;
