<template>
	...
	:auto-upload="false">
————————————————
版权声明：本文为CSDN博主「xiaoheisboy」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/xiaoheisboy/article/details/116569961
  ...
  export default {
    ...
    handleRemove(file, fileList) {
      ...
      handlePhoto(file) {
        ...
        console.log(this.fileList) // 打印见下图  //文件格式
      },
