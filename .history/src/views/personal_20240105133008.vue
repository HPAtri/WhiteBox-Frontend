<template>
    <div class="main">
      <el-dialog :title="dialogTitle" :visible.sync="updateVisible" width="50%"  @close="closeDialogForm()">
        <el-form :model="updateform" :rules="rules" ref="locationform" :inline=true style="margin-left:20px;" label-width="110px" label-position="right" size="mini">
            <el-form-item label="ID" prop="ID">
                <el-input v-model="updateform.ID" suffix-icon="el-icon-edit"></el-input>
            </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
            <el-button type="primary" size="mini" v-show="!isView" @click="submitlocationform()">确定</el-button>
            <el-button type="info" size="mini" @click="closeDialogForm()">取消</el-button>
        </span>
      </el-dialog>
      <div class="PersonTop">
