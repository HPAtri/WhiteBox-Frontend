...
export default {
    ...
    methods:{
      ...
      addChoose(gameId){
        ...
        console.log(this.allRecommendList[this.allRecommendList.length-1])
        // console.log(this.allRecommendList[this.batch * 8 + index])
        // console.log(this.allRecommendList[-1])
