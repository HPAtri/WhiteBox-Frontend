...
<script>
  ...
  export default {
    data() {
      return {
        userList:[],
        myArticles:[{title:"这是标题",inf:"",pic:"https://cdn.hk01.com/di/media/images/dw/20210720/494233049202954240095127.jpeg/Gtaq3XCs2uf6M9GekdCXNBW9HVM_YoBE0mHODdJhzg0?v=w800"}],
        colectArticles:[],
        icon: "",
        nickname: "",
        phone_number:"",
