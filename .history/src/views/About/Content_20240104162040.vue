  ...
  <div class="extra">
    <div class="author">
      <div class="user">
          ...
          <div class="userbox">
          <div class="userName"><span style="font-size: 22px;margin-bottom: 5px;">{{userName}}</span></div>
          <div class="collect"><el-button type="primary" @click="collect(gameid)">{{collect}}</el-button></div></div>
      </div>
    <div class="gameInf">
