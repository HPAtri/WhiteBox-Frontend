  ...
  <div class="extra">
    <div class="author">
      <div class="user">
          ...
          <div class="collect"><el-button type="primary" style=" height:36px;width:90px; font-size: 14px;margin为0 上下为auto margin:0 auto" @click="collect(gameid)">{{collect}}</el-button></div></div>
      </div>
    <div class="gameInf">
