...
<div class="main">
  ...
  <div class="release">
    <div><mavon-editor
              ...
              /></div>
  <div style="margin-top:10px; margin-left: 820px;"><el-button type="primary" style=" height:36px;width:90px; font-size: 12px;" @click="collect(gameid)">评论</el-button>
  </div></div>
  <div class="comments">
    <div class="comment" v-for="(item,index) in commentList" :key="index" @click="tagquery(item.tagId)">
