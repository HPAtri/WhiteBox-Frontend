...
<div class="main">
  ...
  <div class="comments">
    <div class="comment" v-for="(item,index) in userList" :key="index">
      ...
      </div><div>{{commentList[index].commentContent}}</div>
      </div>
  </div>
  </div>
  <div class="extra">
    <div class="author">
      <div class="user">
          ...
          <div class="collect"><el-button type="primary" style=" height:36px;width:90px; font-size: 12px; " @click="collect(gameid)">{{collect}}</el-button></div>
        </div>
      </div>
    <div class="gameInf">
