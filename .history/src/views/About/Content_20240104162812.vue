  ...
  <div class="extra">
    <div class="author">
      <div class="user">
          ...
          <div class="collect"><el-button type="primary" style=" height:35px;width:100px; font-size: 16px;margin为0 上下为auto margin:0 auto" @click="collect(gameid)">{{collect}}</el-button></div></div>
      </div>
    <div class="gameInf">
