...
<div class="main">
  <div class="article">
    <!-- <h4 class="title">{{article[0].title}}</h4> -->
    <div class="inf">
      <!-- <span>作者：{{author}}</span>
      <span>{{time}}</span>
      <span>{{like}}喜欢</span> -->
      <!-- <span>分类：{{article[0].classification}}</span> -->
    </div>
    <!-- <h6 class="content">{{article[0].content}}</h6> -->
  </div>
  <div class="release">
    ...
    getContent(){
      let id = this.$route.query.id
        ...
        .then(res=>{
            ...
            this.classification = article[0].title
            this.content = article[0].title
        })
    },
    likeIt(){
        this.flag = !this.flag
