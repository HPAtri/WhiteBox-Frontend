...
<div class="main">
  ...
  <div class="extra">
    ...
    <div class="gameInf">
      <div class="gameName"><span style="font-size: 22px;">相关游戏</span>
        <p style="margin-top:20px;margin-left:12px;font-size: 16px;">{{name}}</p>
        <div class="score">
      ...
      <div class="gamecover"><img :src="cover" class="cover"></div>
    </div>
