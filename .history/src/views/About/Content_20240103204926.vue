...
<div class="main">
  <div class="article">
    ...
    <div class="inf">
      ...
      <i class="el-icon-view" style="font-size: 14px; margin-right: 40px;">{{views}}</i>
      <i class="el-icon-time" style="font-size: 14px; margin-right: 40px;">{{releaseTime.slice(0, 10)}}</i>
    </div>
