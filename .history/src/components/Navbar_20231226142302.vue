<template>
     <div class="top flex">
      <div class="left">
        ...
        <el-dropdown>
        <span class="down-tabbar-item">
          资讯<i class="el-icon-arrow-down el-icon--right"></i>
        </span>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item><router-link to="/about" class="down-tabbar-item">全部</router-link></el-dropdown-item>
          <el-dropdown-item><router-link to="/about" class="down-tabbar-item">精品</router-link></el-dropdown-item>
          <el-dropdown-item><router-link to="/about" class="down-tabbar-item">杂谈</router-link></el-dropdown-item>
          <el-dropdown-item><router-link to="/about" class="down-tabbar-item">攻略</router-link></el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
      </div>
