     ...
     <div class="top flex">
      <div class="left">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item><router-link to="/about" class="tabbar-item">全部</router-link></el-dropdown-item>
          <el-dropdown-item>精品<router-link to="/about" class="tabbar-item">全部</router-link></el-dropdown-item>
          <el-dropdown-item>杂谈<router-link to="/about" class="tabbar-item">全部</router-link></el-dropdown-item>
          <el-dropdown-item>攻略<router-link to="/about" class="tabbar-item">全部</router-link></el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
