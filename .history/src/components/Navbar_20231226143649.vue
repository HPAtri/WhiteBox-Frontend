     ...
     <div class="top flex">
      <div class="left">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item><router-link to="{ path: '/about', query: { id: '1' } }" class="down-item">杂谈</router-link></el-dropdown-item>
          <el-dropdown-item><router-link to="{ path: '/about', query: { id: '1' } }" class="down-item">攻略</router-link></el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
      </div>
