     ...
     <div class="top flex">
      <div class="left">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item>全部<router-link to="/about" class="tabbar-item">资讯</router-link></el-dropdown-item>
          <el-dropdown-item>精品</el-dropdown-item>
          <el-dropdown-item>杂谈</el-dropdown-item>
          <el-dropdown-item>攻略</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
