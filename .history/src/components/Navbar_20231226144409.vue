     ...
     <div class="top flex">
      <div class="left">
        ...
        <span class="tabbar-item">
          资讯<i class="el-icon-arrow-down el-icon--right"></i>
        </span>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item><router-link :to="{ path: '/about', query: { Classification: '0' } }" class="down-item">全部</router-link></el-dropdown-item>
          <el-dropdown-item><router-link :to="{ path: '/about', query: { Classification: '1' } }" class="down-item">精品</router-link></el-dropdown-item>
          <el-dropdown-item><router-link :to="{ path: '/about', query: { Classification: '2' } }" class="down-item">杂谈</router-link></el-dropdown-item>
          <el-dropdown-item><router-link :to="{ path: '/about', query: { Classification: '3' } }" class="down-item">攻略</router-link></el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
      </div>
